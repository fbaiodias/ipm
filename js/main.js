...
var htmls = {
  "controlos": "<div class=\"description\">Seleccione as funcionalidades que pretende activar.</div><ul title=\"main\"><li><div class=\"has_icon\">Seleccionar todos<input type=\"checkbox\" value=\"all\"></div></li><li><div class=\"has_icon\"><img class=\"icon\" src=\"./img/icons/ac.png\">Ar condicionado<input type=\"checkbox\" value=\"ac\"></div></li><li><div class=\"has_icon\"><img class=\"icon\" src=\"./img/icons/autopilot.png\">Piloto automático<input type=\"checkbox\" value=\"autopilot\"></div></li><li><div class=\"has_icon\"><img class=\"icon\" src=\"./img/icons/radio.png\">Rádio<input type=\"checkbox\" value=\"radio\"></div></li></ul>",
  ...
  "partilha-ajuda": "<ul title=\"partilha\"><div class=\"description\"><span> A partilha de informação permite ao utilizador enviar dados sobre si (nome, destino e fotografia)tal como receber o mesmo tipo de informação de terceiros. </span><br></br><span>No menu de configurações <img src=\"./img/config.png\"> (botão para cima) é possível filtrar a informação a receber e seleccionar com quem partilhar a informação a enviar.</span></div></ul>",
  "partilha-config-enviar": "<div class=\"description\">Seleccione com quem pretende partilhar a sua informação.</div><ul title=\"partilha-config\"><li title=\"name\"><div>Nome<span class=\"privacy\">Ninguém</span> <img class=\"next_img\" src=\"./img/switch.png\"></div></li><li title=\"photo\"><div>Fotografia<span class=\"privacy\">Ninguém</span> <img class=\"next_img\" src=\"./img/switch.png\"></div></li><li title=\"destination\"><div>Destino<span class=\"privacy\">Ninguém</span> <img class=\"next_img\" src=\"./img/switch.png\"></div></li></ul>",
  ...
  "testes-intervalo": "<div class=\"description\">Esta funcionalidade será desactivada após 24 horas.</div><ul title=\"testes\"><li><div>Activar no intervalo seleccionado <input type=\"checkbox\" value=\"active\"></div> </li><li title=\"testes-intervalo-inicio\"><div>Inicio <img class=\"next_img\" src=\"./img/next.png\"></div></li><li title=\"testes-intervalo-fim\"><div>Fim <img class=\"next_img\" src=\"./img/next.png\"></div></li></ul>",
